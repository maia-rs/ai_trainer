...
class ExercicioResponse(BaseModel):
    ...
    created_at: datetime = Field(..., description="Data de criação do exercício") # Alterado de str para datetime
    updated_at: datetime = Field(..., description="Data da última atualização do exercício") # Alterado de str para datetime
