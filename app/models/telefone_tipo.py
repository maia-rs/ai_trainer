...
# Define o tipo customizado do SQLAlchemy
class Telefone(TypeDecorator):

    """Tipo personalizado do SQLAlchemy para armazenar e recuperar telefones.""" 

    impl = String(20) # Armazena como string no banco de dados, com tamanho máximo
    cache_ok = True # Boa prática para TypeDecorators
    ...
    def process_result_value(self, value, dialect):
        ...
        """Converte a string do banco de dados para um objeto TelefoneValue."""
